...
<div class="col-md-12">
    ...
    <div class="widget-body">
        <div class="widget-main">
            <div id="fuelux-wizard-container">
                <h3 class="text-center"> Third Category Information </h3>
    ...
    <form action="{{route('ThirdCategoryAdmin.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
        {{ csrf_field()}}
        <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label for="sub"> Third category </label>

                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                            <span class="block input-icon input-icon-right">
                               <input type="text" name="third_category" id="sub" placeholder=" Third Category" class="form-control">
                            </span>
                        </div>
                    </div>
                            ...
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($cat = App\subcategoryModel::find($value->subcategory_id))
                                        <td>
                                           {{$cat->subcategory_name}}
                                        </td> 
                                        @endif
                                        <td>
                                            {{$value->third_category_name}} 
                                        </td>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="green" href="{{route('ThirdCategoryAdmin.edit',$value->id)}}">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a class="red" href="{{route('ThirdCategoryAdmin.show',$value->id)}}">
