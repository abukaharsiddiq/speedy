					...
					<div class="widget-body">
						<div class="widget-main">
							<div id="fuelux-wizard-container">
								 <h3 class="text-center">Update Slider information </h3>
						...
						<div class="col-md-12">
						  ...
						  <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12 col-md-offset-2 col-lg-offset-2">
							...
							<div class="step-content pos-rel">
								...
								<form action="{{route('SlideAdmin.update',$view->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
								{{ csrf_field()}}
							    {{ method_field('PUT')}}
								  <div class="col-md-12">
