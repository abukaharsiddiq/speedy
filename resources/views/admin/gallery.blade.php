					...
					<div class="widget-body">
						<div class="widget-main">
							<div id="fuelux-wizard-container">
								 <h3 class="text-center"> Gallery information </h3>
						...
						<div class="col-md-12">
						  ...
						  <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12 col-md-offset-2 col-lg-offset-2">
							...
							<div class="step-content pos-rel">
								...
								<form action="{{route('GalleryAdmin.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
								{{ csrf_field()}}
								  <div class="col-md-12">
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="{{route('GalleryAdmin.edit',$value->id)}}">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="{{route('GalleryAdmin.show',$value->id)}}">
