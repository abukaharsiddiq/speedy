					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="{{url('img/logo.png')}}" alt="Jason's Photo" />
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a href="{{ route('logout') }}"
                                           ...
                                           <i class="ace-icon fa fa-cog"></i> Logout
                                        </a>
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text"> Order Information </span>
						...
						<ul class="submenu">
							<?php 
							   $new = App\OrderModel::where('active','=',0)->where('unactive','=',0)->get()->count();
							 ?>
							<li class="">
								<a href="{{route('OrderInfo.index')}}">
									<i class="menu-icon fa fa-caret-right"></i>
									New Order &nbsp;&nbsp; (<b style="color: red"> {{$new}} </b>)
								</a>
							...
							<?php 
							   $conform = App\OrderModel::where('active','=',1)->where('unactive','=',0)->get()->count();
							 ?>
							<li class="">
								<a href="{{route('OrderInfo.create')}}">
									<i class="menu-icon fa fa-caret-right"></i>
									Order Conform (<b style="color: green"> {{$conform}} </b>)
								</a>

								<b class="arrow"></b>
							</li>
							<?php 
							   $cancel = App\OrderModel::where('active','=',0)->where('unactive','=',1)->get()->count();
							 ?>
							<li class="">
								<a href="{{route('OrderCencelView.orderCancel_MemberView')}}">
									<i class="menu-icon fa fa-caret-right"></i>
									Order Cancel (<b style="color: #FFB752;"> {{$cancel}} </b>)
								</a>
							...
							<li class="">
								<a href="{{route('Search.orderSearch')}}">
									<i class="menu-icon fa fa-caret-right"></i>
									Order Search
								</a>
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="{{route('ContactEmail.create')}}">
									<i class="menu-icon fa fa-caret-right"></i>
								   Approve Email
								</a>
					...
					<li class="">
						<a href="{{route('GalleryAdmin.index')}}">
					...
					<li class="">
						<a href="{{route('adminHeadline.index')}}">
							<i class="menu-icon fa fa-list-alt"></i>
							<span class="menu-text"> Head line  </span>
						</a>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder"> F. S. Cosmetics Co. Ltd.  </span>
						 &copy; 2019
						</span>

						&nbsp; &nbsp;
						<!-- <span class="action-buttons">
							<a target="new_tap" href="www.facebook.com">
