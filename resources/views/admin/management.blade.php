					...
					<div class="widget-body">
						<div class="widget-main">
							<div id="fuelux-wizard-container">
								 <h3 class="text-center"> Management information </h3>
						...
						<div class="col-md-12">
						  ...
						  <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12 col-md-offset-2 col-lg-offset-2">
							...
							<div class="step-content pos-rel">
								...
								<form action="{{route('Management_admin.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
								{{ csrf_field()}}
								  <div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-12 col-md-12 padding">
											<span class="block input-icon input-icon-right">
												<input type="text" name="designation" placeholder=" Designation" id="title" class="width-100" />
												<i class="ace-icon fa fa-leaf"></i>
											</span>
										</div>
									</div>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="{{route('Management_admin.edit',$value->id)}}">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="{{route('Management_admin.show',$value->id)}}">
