                                ...
                                <div class="step-content pos-rel">
                                    <div class="step-pane active" data-step="1">
                                        ...
                                        <div class="col-md-12 ">
                                            ...
                                            <form action="{{route('Populer.update',$view->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
                                               {{ csrf_field()}}
                                                 {{ method_field('PUT')}}
                                                <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                                            <span class="block input-icon input-icon-right">
                                                                <textarea class="form-control" value="{{$view->description}}" placeholder="Product description" name="description"> {{$view->description}} </textarea>
                                                            </span>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                                            <span class="block input-icon input-icon-right">
                                                                <input type="text" name="price" placeholder="Price" value="{{$view->price}}" id="price" class="width-100" />
                                                                <i class="ace-icon fa fa-leaf"></i>
                                                            </span>
                                                        </div>
                                                </div>
